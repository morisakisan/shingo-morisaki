...
| **使用ライブラリー** | Android Architecture Components(Live DataViewModelなど)RxJava<br>Retrofit<br>Dagger2<br>Picasso<br>OkHttp |
...
| **使用ライブラリー** | SVN<br>Eclipse<br>AndroidSDK |
...
| **プロジェクトの役割** | PG |
| **使用言語** | Java<br>XML<br>SQLite |
| **使用ライブラリー** | Eclipse<br>AndroidSDK |
