...
| プロジェクトの役割 | PG |
| 使用言語 | Kotlin  Java |
| 使用ツールとライブラリー | Android Architecture Components  RxJava2  Mockito  Robolectric  Dagger2  Retrofit|
...
| **項目名**                   | **内容** |
|------------------------------|----------|
| **業務内容**                 | 100問テストの受験を行うWEBアプリケーションのスマートフォン対応 |
...
| **項目名**                   | **内容** |
|------------------------------|----------|
| **業務内容**                 | マニュアル作成アプリの新機能開発及び保守・運用 |
| **在籍期間**                 | 2016年9月 〜 2017年6月 |
| **チーム編成**               | チーム3名  開発3名  全体3名 |
| **プロジェクトの役割**       | PG |
| **使用言語**                 | -（記載なし） |
| **使用ツールとライブラリー** | GitHub  AndroidStudio  JUnit |
...
| **プロジェクトの役割**       | PG |
| **使用言語**                 | Java  XML |
| **使用ツールとライブラリー** | SQLite  Linux  Git  Atom  jQuery  GitHub  AndroidStudio  AndroidSDK  JUnit |
...
| **項目名**                   | **内容** |
|------------------------------|----------|
| **業務内容**                 | ポータルサービスの提供するゲームアプリの保守・運用及び新規開発 |
| **在籍期間**                 | 2015年1月 〜 2016年1月 |
| **チーム編成**               | チーム3名  開発2名  全体3名 |
| **プロジェクトの役割**       | PG |
| **使用言語**                 | Java  XML  C  C++  シェルスクリプト |
| **使用ツールとライブラリー** | Git  GitHub  AndroidStudio  AndroidSDK  AndroidNDK  Jenkins  sphinx |
...
| **項目名**                   | **内容** |
|------------------------------|----------|
| **業務内容**                 | 某キャラクターのアラームアプリの開発 |
| **在籍期間**                 | 2013年7月 〜 2013年9月 |
| **チーム編成**               | チーム2名  開発1名  全体2名 |
| **プロジェクトの役割**       | PG |
| **使用言語**                 | Java  XML  SQLite |
| **使用ツールとライブラリー** | Eclipse  AndroidSDK |
